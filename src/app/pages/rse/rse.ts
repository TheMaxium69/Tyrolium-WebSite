  ...
  readonly initiatives = [
    {
      ...
      descEn: "A support programme for tech project holders who share our values: excellence, independence and French ambition. We provide network, expertise and infrastructure.",
      badge: 'Actif',
      badgeEn: 'Active',
    },
    {
    ...
    {
      icon: 'ri-user-fill',
      title: 'Useritium — Le compte français',
      titleEn: 'Useritium — The French account',
